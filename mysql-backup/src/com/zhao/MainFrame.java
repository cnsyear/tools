...
public class MainFrame extends JFrame {
	...
	private void initComponents() {
		...
		this.txt_dbUrl.setText("localhost:3306");
		...
		this.txt_dbPwd.setText("1qaz4321");
	...
	private void btn_confirmActionPerformed(ActionEvent evt) {
		//数据库连接用户名和密码
		SelectSchemaFrame.userName = txt_dbUser.getText();
		SelectSchemaFrame.password = txt_dbPwd.getText(); 
