...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://server.cnsyear.com/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://server.cnsyear.com/", "getOrderByIdResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cnsyear.com/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cnsyear.com/", name = "getOrderByIdResponse")
